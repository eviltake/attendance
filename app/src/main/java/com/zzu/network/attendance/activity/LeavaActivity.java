...
public class LeavaActivity extends AppCompatActivity {
    private static String TAG = "LeavaActivity";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_queryleava);
        Log.d(TAG, "onCreate");
    ...
    private void initData() {
        List<Student> students = GreenDaoManager.getInstance().getNewSession().getStudentDao().queryBuilder()
                .where(StudentDao.Properties.Leava.notEq(0)).build().list();
